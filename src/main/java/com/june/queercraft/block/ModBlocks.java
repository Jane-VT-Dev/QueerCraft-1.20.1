...
public class ModBlocks {
    ...
    public static final Block RAW_BROWN_ORE_BLOCK = registerBlock("raw_brown_ore_block",
            new Block(FabricBlockSettings.create().hardness(1.2f).sounds(BlockSoundGroup.STONE).solid()));

    public static final Block BROWN_BLOCK = registerBlock("brown_block",
            new Block(FabricBlockSettings.create().hardness(1.2f).sounds(BlockSoundGroup.METAL).solid()));
